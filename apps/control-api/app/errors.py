"""Structured error model for the Control API.

Every error response follows the envelope defined in
docs/specs/API_CONTRACT.md and docs/specs/ERROR_MODEL.md::
...
class ApiError(Exception):
    ...
    Example::
        ...
        raise ApiError(501, "NOT_IMPLEMENTED", "Not implemented yet.")
    """
